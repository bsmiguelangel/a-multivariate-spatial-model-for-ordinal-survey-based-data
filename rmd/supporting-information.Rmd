---
title: 'Supporting information for "A multivariate spatial model for ordinal survey-based data"'
author: |
...
This R Markdown file provides a formatted version of the analysis performed using
the original survey data. It contains the code used to obtain the analyses,
tables, and figures reported in the manuscript.

Running this file requires access to the original survey data file
ESCV2022_UV_Matem.sav. Precomputed posterior samples are loaded to avoid
repeating the computationally intensive MCMC fitting step.
...
```{r}
round(salwinbugs3$summary, 4)[startsWith(labels(salwinbugs3$summary)[[1]], "kappa"), ][1:10, ]
...
salwinbugs1$summary[startsWith(labels(salwinbugs1$summary)[[1]], "kappa"), ][1:10, ]
salwinbugs1$summary[startsWith(labels(salwinbugs1$summary)[[1]], "theta"), ][1:10, ]
...
salwinbugs2$summary[startsWith(labels(salwinbugs2$summary)[[1]], "kappa"), ][1:10, ]
salwinbugs2$summary[startsWith(labels(salwinbugs2$summary)[[1]], "theta"), ][1:10, ]
...
salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], "kappa"), ][1:10, ]
salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], "theta"), ][1:10, ]
salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], "psi"), ][1:10, ]
