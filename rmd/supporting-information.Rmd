---
title: 'Supporting information for "A multivariate framework for analyzing spatial ordinal survey-based data / A multivariate spatial model for ordinal survey-based data"'
author: |
...
# Model-Corr&IRE
corrire[[1]]$mean[5, ]; corrire[[1]]$PI$lower[5, ]; corrire[[1]]$PI$upper[5, ]; corrire[[1]]$real[5, ]
```
