---
title: 'Supplemental material for "A multivariate framework for analyzing spatial ordinal survey-based data / A multivariate spatial model for ordinal survey-based data"'
author: |
...
MCMCtrace(object = salnimble1,
          ...
          exact = TRUE,
          ISB = FALSE,
          params = rownames(salwinbugs1$summary[startsWith(labels(salwinbugs1$summary)[[1]], test), ])[(salwinbugs1$summary[startsWith(labels(salwinbugs1$summary)[[1]], test), 6] > 1.05) | (salwinbugs1$summary[startsWith(labels(salwinbugs1$summary)[[1]], test), 7] < 200)])
```
...
MCMCtrace(object = salnimble2,
          ...
          exact = TRUE,
          ISB = FALSE,
          params = rownames(salwinbugs2$summary[startsWith(labels(salwinbugs2$summary)[[1]], test), ])[(salwinbugs2$summary[startsWith(labels(salwinbugs2$summary)[[1]], test), 6] > 1.05) | (salwinbugs2$summary[startsWith(labels(salwinbugs2$summary)[[1]], test), 7] < 200)])
```
...
MCMCtrace(object = salnimble3,
          ...
          exact = TRUE,
          ISB = FALSE,
          params = rownames(salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], test), ])[(salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], test), 6] > 1.05) | (salwinbugs3$summary[startsWith(labels(salwinbugs3$summary)[[1]], test), 7] < 200)])
```
...
### Figure 2: Maps of the RV - P(theta < 0 | y)
...
corrire <- readRDS(file = file.path("..", "results", "multi-2022-nimble-MH-corr-ire-assessment.rds"))
```

#### Item 1: Have you been able to concentrate on what you were doing?
...
#### Item 2: Have you lost a lot of sleep because of worries?
...
#### Item 3: Have you felt that you have been playing a useful role in life?
...
#### Item 4: Have you felt capable of making decisions?
...
#### Item 5: Have you constantly felt overwhelmed and under stress?
...
#### Item 6: Have you felt unable to overcome your difficulties?
...
#### Item 7: Have you been able to enjoy your daily activities?
...
#### Item 8: Have you been able to face up to your problems?
...
#### Item 9: Have you felt unhappy or depressed?
...
#### Item 10: Have you lost confidence in yourself?
...
#### Item 11: Have you felt that you are a worthless person?
...
#### Item 12: Have you felt reasonably happy, considering all the circumstances?
